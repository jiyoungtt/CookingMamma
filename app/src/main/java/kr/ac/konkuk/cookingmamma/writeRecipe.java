...
public class writeRecipe extends Activity {
   ...
   //레시피에 들어갈 식재료 추가
    public void addIngredient(View view){
       final String rein = recipe_ingredient.getText().toString();
        ingredient_textview.setText(ingredient_textview.getText().toString()+","+rein);

        StringBuffer stringBuffer = new StringBuffer();
        stringBuffer.append(rein.toString()+"\t");
    ...
    public void saveRecipe(View view){//저장버튼을 클릭했을때
        ...
        String photo = tempFile.getAbsolutePath().toString();




        Recipe recipe = new Recipe(ingredient,title, content , photo);
        ...
        recipeRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot snapshot1: snapshot.getChildren()){
                    ...
                    String myingredient = recipe.getIngredient();
                    String mytitle = recipe.getTitle();
                    String mycontent = recipe.getContent();
        ...
        DatabaseReference dataRef1 = rootRef.child("Recipe");
        dataRef1.push().setValue(recipe);
